<x-app-layout>
    <x-slot name="header">
        ...
        <section class="container mx-auto lg:px-24 md:px-10 px-4 py-5">
            <h2 class="font-bold text-3xl text-gray-800 leading-tight">Tambah Beasiswa</h2>
        </section>
        {{-- Form untuk menambah beasiswa --}}
        <div class="container mx-auto mt-8 lg:px-24 md:px-10 px-4 py-5">
            ...
            <form action="{{ route('admin.beasiswa.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="nama" name="nama"
                            class="w-full border-gray-300 rounded mt-2 text-base " value="{{ old('nama') }}">
                        @error('nama')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="asal_negara" name="asal_negara"
                            class="w-full border-gray-300 rounded mt-2 text-base " value="{{ old('asal_negara') }}">
                        @error('asal_negara')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <label for="asal_negara" class="block text-black text-sm">Awal</label>
                        <input type="date" id="mulai_tanggal" name="mulai_tanggal"
                            class="w-1/2 border-gray-300 rounded mt-2 text-base " value="{{ old('mulai_tanggal') }}">
                        @error('mulai_tanggal')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        <label for="asal_negara" class="block text-black text-sm">Akhir</label>
                        <input type="date" id="deadline_tanggal" name="deadline_tanggal"
                            class="w-1/2 border-gray-300 rounded mt-2 text-base " value="{{ old('deadline_tanggal') }}">
                ...
                <div>
                    ...
                    <div class="mb-4">
                        <label for="syarat_ketentuan" class="block text-black text-sm">Syarat &
                            Ketentuan</label>
                        <textarea id="syarat_ketentuan" name="syarat_ketentuan" class="w-full border-gray-300 rounded mt-2 text-base ">{{ old('syarat_ketentuan') }}</textarea>
                    ...
                    <div class="mb-4">
                        <label for="link_pendaftaran" class="block text-black text-sm">Link
                            Pendaftaran</label>
