<x-app-layout>
    <x-slot name="header">
        ...
        <section class="container mx-auto lg:px-24 md:px-10 px-4 py-5">
            <h2 class="font-bold text-3xl text-gray-800 leading-tight">Daftar User</h2>
        </section>
                ...
                <table class="table w-full border border-neutral-900">
                    <thead class="bg-[#8ECAE6] text-2xl border-b border-neutral-900">
                        <tr>
                            ...
                            <th class="border-r border-neutral-900">Foto</th>
                            <th class="border-r border-neutral-900">Nama</th>
                            <th class="border-r border-neutral-900">Email</th>
                    ...
                    <tbody>
                        ...
                        <tr class="hover:bg-neutral-50 ease-in-out duration-200 border-b border-neutral-900">
                            ...
                            <td class="border-r border-neutral-900 px-1">{{ $i->name }}</td>
                            <td class="border-r border-neutral-900 px-1">{{ $i->email }}</td>
                            
                         
                         
                            <td class="border-r py-1 border-neutral-900">
                                <div class="flex justify-center">
                                    <a href="{{ route('admin.user.edit', $i->id) }}" class="px-1 py-2 text-neutral-50 rounded w-fit mx-auto bg-[#0077B6]">+ Update</a>
                                </div>
                            </td>
                            <td class="py-1">
                                <div class="flex justify-center">
                                    <form action="{{ route('admin.user.destroy', $i->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
